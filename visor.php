...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .delete-confirm-box .dc-left {
            display: flex;
            align-items: center;
            gap: 14px;
        }

        .delete-confirm-box i.warn-icon {
            font-size: 26px;
            color: #f97316;
            flex-shrink: 0;
        }

        .delete-confirm-box h6 {
            font-size: 13px;
            font-weight: 600;
            color: var(--text);
            margin-bottom: 2px;
...
<div class="main-wrapper">
    ...
    <div id="content-area">
        ...
        <div class="monitor-wrap">
            <!-- Barra superior decorativa tipo OS -->
        ...
        <div class="edit-name-box" id="edit-name-box">
            <div class="dc-inner">
                <div class="dc-left" style="flex:1;">
                    <i class="bi bi-pencil-square warn-icon" style="color:var(--accent);"></i>
                    <div style="flex:1;">
...
<div class="status-bar">
    ...
    <span class="status-text" id="status-bar-text">
